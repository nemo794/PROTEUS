...
def _get_wtr2_translucent_clouds_ctable(
    ...
    # will be applied to all existing colors with alpha=`alpha`
    # translucency.
...
def generate_dswx_layers(input_list,
    ...
    if output_browse_image:
        ...
        # and they will be colored as opaque snow.
        # If `flag_no_snow_mask_browse` is True, then no pixels would be set to
        # WTR_CLOUD_MASKED_SNOW, and so implicitly no pixels would be
        # colored as snow.
